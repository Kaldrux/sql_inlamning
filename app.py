...
DB_CONFIG = {
    ...
    'database': 'inlämning'  # TODO: Ändra detta till ditt databasnamn
}
...
def login():
    ...
    if request.method == 'POST':
        username = request.form['username'] # TODO: Hämta det username som POSTats med requesten
        password = request.form['password'] # TODO: Hämta det password som POSTats med requesten
